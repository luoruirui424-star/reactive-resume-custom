...
<Step title="Enter a model name">
  In the <Badge>Model</Badge> field, enter the model you want to use (for example, <code>gpt-4</code>,{" "}
  <code>claude-3-5-sonnet</code>, <code>gemini-1.5-flash</code>, <code>qwen-turbo</code>, or <code>deepseek-chat</code>).
</Step>
